...
export function StackCloud() {
  ...
  return (
    <Section
      id='stack'
      title='Стек'
      subtitle='Использую современный стек для создания быстрых и поддерживаемых интерфейсов. Делаю упор на типизацию, переиспользуемость и чистую структуру проекта.'
      right={
